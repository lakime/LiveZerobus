...
export default function SummaryBar({ summary }: { summary: Summary | null }) {
  return (
    <div className="summary">
      <Kpi label="Seeds below reorder" value={summary ? fmt.format(summary.skus_below_reorder) : "—"} />
      ...
      <Kpi label="PO drafts open"       value={summary ? fmt.format(summary.po_drafts_open) : "—"} />
      <Kpi label="Unread supplier mail" value={summary ? fmt.format(summary.inbound_unprocessed) : "—"} />
